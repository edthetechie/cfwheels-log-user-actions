<cfcomponent displayname="Log User Actions" output="false" mixin="model">
	...
	<cffunction name="$logUserActionsSetCreatedBy" returntype="boolean" output="false" mixin="model">
		<cfif StructKeyExists(variables.wheels.class.properties, variables.wheels.class.logUserActions.createProperty)and IsDefined(variables.wheels.class.logUserActions.userIdLocation)>
	...
	<cffunction name="$logUserActionsSetUpdatedBy" returntype="boolean" output="false" mixin="model">
		<cfif StructKeyExists(variables.wheels.class.properties, variables.wheels.class.logUserActions.updateProperty) and IsDefined(variables.wheels.class.logUserActions.userIdLocation)>
	...
	<cffunction name="$addDeleteClause" returntype="array" access="public" output="false" mixin="model">
		...
		<cfif StructKeyExists(variables.wheels.class, "logUserActions") and variables.wheels.class.softDeletion and arguments.softDelete and StructKeyExists(variables.wheels.class.properties, variables.wheels.class.logUserActions.deleteProperty) and IsDefined(variables.wheels.class.logUserActions.userIdLocation)>
